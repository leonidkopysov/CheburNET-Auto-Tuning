...
## Официальный релиз 1.0.1

[Скачать релиз](https://github.com/leonidkopysov/CheburNET-Auto-Tuning/releases/tag/v1.0.1) · [Изменения](RELEASE_NOTES.md)

Версия прошла автоматические проверки GitHub Actions: Bash, ShellCheck,
16 регрессионных тестов и контрольную сумму. Автор проекта подтвердил успешный
запуск на реальной машине. Это подтверждение конкретного запуска, а не испытание
всех поддерживаемых ОС и архитектур.
